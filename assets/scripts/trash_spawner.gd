...
func _on_conductor_beat(position):
	...
	if (song_position_in_beats >= 0 && song_position_in_beats < 16):
		...
		spawn_3_beat = 0
		spawn_4_beat = 0
	if (song_position_in_beats >= 19 && song_position_in_beats < 32):
		spawn_1_beat = 0
		spawn_2_beat = 1
		spawn_3_beat = 0
		spawn_4_beat = 0
	if (song_position_in_beats >= 35 && song_position_in_beats < 44):
		spawn_1_beat = 0
		spawn_2_beat = 1
		spawn_3_beat = 0
		spawn_4_beat = 0
	if (song_position_in_beats >= 47 && song_position_in_beats < 56):
		spawn_1_beat = 0
		spawn_2_beat = 1
		spawn_3_beat = 0
		spawn_4_beat = 0
	if (song_position_in_beats >= 59 && song_position_in_beats < 76):
		spawn_1_beat = 0
		spawn_2_beat = 1
		spawn_3_beat = 0
		spawn_4_beat = 0
	if (song_position_in_beats >= 83 && song_position_in_beats < 100):
		spawn_1_beat = 0
		spawn_2_beat = 1
		spawn_3_beat = 0
		spawn_4_beat = 0
	if (song_position_in_beats >= 107 && song_position_in_beats < 76):
		spawn_1_beat = 0
		spawn_2_beat = 1
		spawn_3_beat = 0
		spawn_4_beat = 0
